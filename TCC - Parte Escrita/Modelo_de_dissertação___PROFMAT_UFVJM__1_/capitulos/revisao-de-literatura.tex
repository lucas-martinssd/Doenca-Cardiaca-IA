...
A compara\c c\~ao entre os resultados de \citeonline{ravani2024} e o presente estudo \'e particularmente elucidativa. O melhor modelo do presente trabalho no Banco 1 foi o MLP Sklearn na configura\c c\~ao C2 (1.000 \'epocas, $\eta = 0{,}001$), uma das tr\^es configura\c c\~oes de treinamento avaliadas sistematicamente neste trabalho (C1, C2 e C3, detalhadas na Se\c c\~ao~\ref{sec:hiperparametros}), com $88{,}04\%$ de acur\'acia. O ADALINE Sklearn atingiu $86{,}23\%$ na configura\c c\~ao C2. Ambos os valores s\~ao vis\'ivelmente pr\'oximos do KNN reportado por \citeonline{ravani2024} ($89\%$), com diferen\c cas de no m\'aximo 2 a 3 pontos percentuais entre os melhores resultados dos dois trabalhos.
