...
A Figura~\ref{fig:matrizes_banco1} apresenta as matrizes de confusão de todos os modelos na configuração C3 (3.000 épocas, $\eta = 0{,}0001$), permitindo visualizar a distribuição completa de acertos e erros.
