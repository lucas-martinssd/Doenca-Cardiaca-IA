...
\begin{itemize}
  \item \textbf{Interpretabilidade}: modelos de alta complexidade, como redes neurais profundas, funcionam como ``caixas-pretas'', dificultando a explica\c c\~ao das decis\~oes diagn\'osticas por parte do cl\'inico;
  \item \textbf{Valida\c c\~ao externa}: a maioria dos modelos \'e desenvolvida e validada em conjuntos de dados espec\'ificos, sem testes de generaliza\c c\~ao em popula\c c\~oes diversas;
  \item \textbf{Qualidade dos dados}: dados cl\'inicos frequentemente apresentam valores ausentes, inconsist\^encias e vi\'eses de sele\c c\~ao que impactam o desempenho dos modelos;
  \item \textbf{Quest\~oes \'eticas e regulat\'orias}: a integra\c c\~ao de sistemas de IA \`a assist\^encia m\'edica levanta quest\~oes sobre responsabilidade, privacidade de dados e a rela\c c\~ao m\'edico-paciente.
\end{itemize}
