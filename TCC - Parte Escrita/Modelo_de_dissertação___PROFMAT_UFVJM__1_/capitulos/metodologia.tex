...
Sexo                         & 2 (Masculino, Feminino)         & 1 (Masculino = 1, Feminino = 0) \\
...
Cabe observar que o valor $42$ adotado como semente aleatória, à semelhança dos hiperparâmetros de treinamento (épocas e taxa de aprendizado), foi definido de forma arbitrária, sem processo formal de otimização; alternativas metodologicamente mais rigorosas para a seleção de parâmetros dessa natureza são discutidas na Seção~\ref{sec:potencial_mlp}.
...
Os valores \texttt{max\_iter=3000} e \texttt{eta0=0.0001} exibidos correspondem à configuração C3, definida juntamente com C1 e C2 na Seção~\ref{sec:hiperparametros}. Para as configurações C1 ($500$ épocas, $\eta = 0{,}01$) e C2 ($1.000$ épocas, $\eta = 0{,}001$), o modelo foi reinstanciado com os valores correspondentes da Tabela~\ref{tab:configuracoes}.
...
{\sloppy Os valores \texttt{max\_iter=3000} e \texttt{learning\_rate\_init=0,0001} exibidos correspondem à configuração C3, definida juntamente com C1 e C2 na Seção~\ref{sec:hiperparametros}. Para as configurações C1 ($500$ épocas, $\eta = 0{,}01$) e C2 ($1.000$ épocas, $\eta = 0{,}001$), o modelo foi reinstanciado com os valores correspondentes da Tabela~\ref{tab:configuracoes}.\par}
